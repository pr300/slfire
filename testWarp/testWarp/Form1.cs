       ...
       //     Class1.Set_Delays_9_10(t3, t4);
        ...
        private void OnTimedEvent()
        {
            ...
            while (crThread)
            {
                ...
                //long end = fileLoader.endPosition;
                if (IsHandleCreated)
                {
                    //Invoke(new Action(() =>
                    //  {
        ...
        private void bt_sendSignals_Click(object sender, EventArgs e)
        {
            ...
            SpIceController.m_inputSignals = s;
            SpIceController.processSignals();
        }
        ...
        private void cb_run_CheckedChanged(object sender, EventArgs e)
        {
            ...
            SpIceController.StartLayer(cb_run.Checked);
